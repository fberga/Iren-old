...
namespace Iren.FrontOffice.Tools
{
    class Style
    {
        ...
        public static void StdStyles()
        {
            ...
            try
            {
                style = Globals.ThisWorkbook.Styles["gotoBarStyle"];
            }
            catch
            {
                style = Globals.ThisWorkbook.Styles.Add("gotoBarStyle");
                ...
                style = Globals.ThisWorkbook.Styles.Add("navBarStyle");
                ...
                style = Globals.ThisWorkbook.Styles.Add("titleBarStyle");
                style.Font.Bold = true;
                style.Font.Size = 16;
                style.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;
                style.VerticalAlignment = Excel.XlVAlign.xlVAlignCenter;
                ...
                style = Globals.ThisWorkbook.Styles.Add("dateBarStyle");
                style.Font.Bold = true;
                style.Font.Size = 10;
                style.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;
                style.VerticalAlignment = Excel.XlVAlign.xlVAlignCenter;
                ...
                style = Globals.ThisWorkbook.Styles.Add("chartsBarStyle");
                style.Font.Size = 10;
                style.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;
                style.VerticalAlignment = Excel.XlVAlign.xlVAlignCenter;
                style.NumberFormat = "dddd d mmmm yyyy";
                ...
                style = Globals.ThisWorkbook.Styles.Add("allDatiStyle");
                style.Font.Size = 10;
                style.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;
                style.VerticalAlignment = Excel.XlVAlign.xlVAlignCenter;
                ...
                style = Globals.ThisWorkbook.Styles.Add("titoloVertStyle");
                style.Font.Bold = true;
                style.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;
                style.VerticalAlignment = Excel.XlVAlign.xlVAlignCenter;
                style.Interior.ColorIndex = 2;
